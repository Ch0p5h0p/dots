...
hl.config({
    general = {
        ...
        col = {
            active_border = { colors = { "rgba(b4befeff)", "rgba(eff1f5ff)" }, angle = 45 },
            inactive_border = "rgba(585b70aa)",
        },
        --col.active_border = rgba(585b70aa)
    ...
    --bind = ,XF86AudioLowerVolume, exec, wpctl -- set-volume 0 -10%
    --bind = ,XF86AudioRaiseVolume, exec, wpctl -- set-volume 0 +10%
    --bind = ,XF86AudioMute, exec, wpctl -- set-mute 0 toggle
    --bind = ,XF86AudioMicMute, exec, wpctl -- set-source-mute 0 toggle
    --bind = ,XF86MonBrightnessDown, exec, brightnessctl s 10%-
    --bind = ,XF86MonBrightnessUp, exec, brightnessctl s +10%
    -- Move focus with mainMod + arrow keys
    -- Switch workspaces with mainMod + [0-9]
    -- Move active window to a workspace with mainMod + SHIFT + [0-9]
    -- Move active window without switching workspaces
